...
export const sections = [
  ...
  },
  {
    ...
    "extraCount": 2,
    "notes": "href updated 2026-09-03: creative_code.md was renamed/moved to webtech.md when the docs/ content-folder reorg absorbed it as the new Webtech umbrella page (see conversation-backend-and-deploy.md Part 6) -- section id/title left unchanged, that's a separate labeling decision, not part of the physical move."
  },
  {
    "id": "compass",
    "title": "Compass Rose",
