...
// documentation/landing-page-v3-notes.2.0.md for the reference article) -- adapted here so
...
// own sampling resolution -- see documentation/landing-page-v3-notes.2.0.md). Rather than
...
// not just a radius dip. See documentation/landing-page-v3-notes.2.0.md for the fuller
...
// documentation/landing-page-v3-notes.2.0.md) are built by the caller as: build H once
