...
_Auto-generated 2026-09-08 05:01 UTC by `tools/generate_sitemap.py` from `content/cabinet-sections.tsv`, `content/cabinet-entries.tsv`, and `mkdocs.yml`'s own nav tree -- do not hand-edit, re-run the script to refresh._
...
| `teaching` | Teaching | `teaching/` | true | N |
| `visual-field-notes` | Visual Field Notes | `--` | wip | -- |
| `machines-makings` | Machines & Makings | `makings/` | true | N |
| `interfaces-data-texts` | Interfaces, Data & Texts | `webtech/` | true | N |
| `compass` | Compass Rose | `--` | true | -- |
| `web-tech` | WebTech | `webtech/` | true | N |
| `fab` | Fab | `--` | wip | -- |
...
| `makings-3d-printing` | machines-makings | 3D Printing | `3dp/3DP_2019/` | false | Y (3DP in 2019) |
...
| `dataviz` | interfaces-data-texts | Data Visualisations | `--` | false | -- |
...
- **Duplicate href** (`webtech`): section `interfaces-data-texts`, section `web-tech`
...
- **TSV row with no nav entry**: section `machines-makings` (`makings/`)
- **TSV row with no nav entry**: section `interfaces-data-texts` (`webtech/`)
