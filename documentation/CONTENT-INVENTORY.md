...
_Auto-generated 2026-09-23 09:02 UTC by `tools/generate_sitemap.py` from `content/cabinet-sections.tsv`, `content/cabinet-entries.tsv`, and `mkdocs.yml`'s own nav tree -- do not hand-edit, re-run the script to refresh._
...
| `writings` | Writings | `writings/` | true | Y (writings/index.md) |
...
| `writings-poetry` | writings | Poetry | `writings/poems/` | true | Y (Poems) |
| `writings-essays` | writings | Essays | `writings/essays/` | true | Y (Essays) |
...
| `students-creative-coding-2025-26` | teaching | Creative Coding | `teaching/ssd-creative-coding-2025-26/` | true | Y (SSD Creative Coding 2025-26) |
| `students-creative-coding-2024-25` | teaching | Creative Coding 2024-25 | `teaching/ssd-creative-coding-2024-25/` | true | Y (SSD Creative Coding 2024-25) |
| `students-creative-coding-2023-24` | teaching | Creative Coding 2023-24 | `teaching/ssd-creative-coding-2023-24/` | true | Y (SSD Creative Coding 2023-24) |
| `gallery-papiermache` | teaching | Playing with Pulp | `teaching/papiermache/` | true | Y (Playing with Pulp) |
| `gallery-dragons` | teaching | Dragons of SSD | `teaching/dragons/` | wip | Y (Dragons of SSD) |
| `students-emergent-technology` | teaching | Emergent Technology | `teaching/#emergent-technology` | true | N |
...
| `writings-misc` | writings | Miscellany | `writings/miscellany/` | true | Y (Miscellany) |
...
| `fab-23` | fab | Fab 23 Bhutan | `fab/fab23-bhutan/` | false | Y (Fab 23 Bhutan) |
| `fab-25` | fab | Fab 25 Czechia | `--` | false | -- |

## Flags

- **Nav entry with no TSV row**: "fab/index.md" (`fab/index.md`)
