...
| `docs/teaching/index.md` + `docs/teaching/*.md` | Teaching landing page + per-cohort write-ups (class-2023-24, class-2025-26). |
| `docs/makings/index.md` + `docs/makings/*.md` | Machines & Makings landing page + making-process write-ups (drawing machines, lasercutting, origami/paper, `mini_loom.md`). |
