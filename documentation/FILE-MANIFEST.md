...
| File | Role |
|---|---|
| `Landing-page-notes.2.0.md` | Exhaustive versioned dev log (v3.0–v3.7.69) for the `landing-v3/` map rebuild — design decisions, verification, changelog. Large (374KB+). Technical reference: what the system is and how it works. |
