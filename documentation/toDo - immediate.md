...
- [ ] **Add deployment validation.**
  - Validate active TSV destinations.
  - Verify generated landing data is current.
  - Require entry points for standalone projects.
  - Validate assembled Teaching routes.
  - Reject destination collisions.
  - Run strict MkDocs builds.
- [ ] **Generalize external-repository assembly.**
  - Replace repeated workflow blocks with a manifest.
  - Record repository, optional source subfolder, deployment destination,
    required entry point/assets, and validation rules.
