...
// removed)" (explicit design decision, see documentation/landing-page-v3-notes.2.0.md) --
...
// documentation/landing-page-v3-notes.2.0.md. Sections with zero visible entries (hence
...
// documentation/landing-page-v3-notes.2.0.md for why entries and extras no longer share
...
export function render() {
  ...
  // documentation/landing-page-v3-notes.2.0.md).
  ...
  // see documentation/landing-page-v3-notes.2.0.md's "Canvas + legend" entry for why) as
  ...
  // documentation/landing-page-v3-notes.2.0.md for why this is a single combined trace
