...
// docs/sitemap.md) directly from content/now.tsv + docs/assets/js/now-data.js.
...
const dataPath = path.join(root, "docs", "assets", "js", "now-data.js");
const markdownPath = path.join(root, "docs", "assets", "js", "now-markdown.js");
